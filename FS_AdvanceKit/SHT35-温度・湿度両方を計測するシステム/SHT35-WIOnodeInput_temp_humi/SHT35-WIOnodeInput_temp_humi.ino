...
void setup()
{
  ...
  Azure.begin("HostName=ichikawaiothub.azure-devices.net;DeviceId=ichikawa01;SharedAccessKey=+K1QQXpoEM0Ym+6deEnz6fcWDgTtJrRRrpywtROSbe0=");   //YourKey Example:"HostName=YourHost.azure-devices.net;DeviceId=YourDevice;SharedAccessKey="
