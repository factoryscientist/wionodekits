...
void setup() {
  Serial.begin(115200);
  WiFi.begin("SSIDをいれてください", "パスワードを入れてください");
  Azure.begin("iot hubの接続文字列をいれてください"); //YourKey Example:"HostName=YourHost.azure-devices.net;DeviceId=YourDevice;SharedAccessKey="
...
//calculate mean
  ...
  float current_amplitude = (max_data - min_data)*3.2/1000; // ÷ 2 * 3[mv per unit] ÷ 100[ohm] * 3000 ÷ 1.4
